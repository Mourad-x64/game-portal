...
class ImageWorkshopLayer
{
     ...
     * @param PHPImageWorkshop_ImageWorkshop $layer
    ...
    public function mergeDown($layerId)
    {
        ...
        if ($this->isLayerInIndex($layerId)) {
            ...
            if ($layerLevel > 1) {
                ...
                $layerTmp = PHPImageWorkshop_ImageWorkshop::initVirginLayer($layerTmpWidth, $layerTmpHeight);
                ...
                $layerTmp = PHPImageWorkshop_ImageWorkshop::initFromResourceVar($this->image);
            ...
            if ($converseProportion) { // Proportion are conserved
                ...
                if ($newWidth && $newHeight) { // Proportions + $newWidth + $newHeight
                    ...
                    if ($this->getWidth() != $newWidth || $this->getHeight() != $newHeight) {
                        ...
                        $layerTmp = PHPImageWorkshop_ImageWorkshop::initVirginLayer($newWidth, $newHeight);
    ...
    public function crop($unit = self::UNIT_PIXEL, $width = 0, $height = 0, $positionX = 0, $positionY = 0, $position = 'LT')
    {
        ...
        if (($width != $this->width || $positionX == 0) || ($height != $this->height || $positionY == 0)) {
            ...
            $layerTmp = PHPImageWorkshop_ImageWorkshop::initVirginLayer($width, $height);
            $layerClone = PHPImageWorkshop_ImageWorkshop::initVirginLayer($this->width, $this->height);
     ...
     * @param integer $layerId
     *
     * @return PHPImageWorkshop_ImageWorkshop
     */
